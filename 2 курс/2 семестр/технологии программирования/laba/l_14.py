...
class Library:
    ...
    async def create_request(self, reader = Reader(), book = Book()):
...
async def main():
    ...
    for i in range(len(readers)):
        await queue.put(library.create_request(readers[i], books[i]))


    for i in range(len(readers)):
        try:
            await asyncio.gather(asyncio.create_task(queue))
        except Exception:
    ...
    # try:
    #     await library.create_request(reader_1, book_1)
    # except Exception:
    #     print('Даної книги нажаль немає')
    #
    # try:
    #     await library.create_request(reader_2, book_2)
    # except Exception:
    #     print('Даної книги нажаль немає')
    #
    # try:
    #     await library.create_request(reader_3, book_3)
    # except Exception:
    #     print('Даної книги нажаль немає')
    #
    # try:
    #     await library.create_request(reader_4, book_4)
    # except Exception:
    #     print('Даної книги нажаль немає')
    #
    # try:
    ...
    #
    # try:
    #     await library.create_request(reader_5, book_5)
    # except Exception:
    #     print('Даної книги нажаль немає')
    #
    # try:
    #     await library.create_request(reader_6, book_6)
    # except Exception:
    #     print('Даної книги нажаль немає')
    #
    # try:
    #     await library.create_request(reader_7, book_7)
    # except Exception:
    #     print('Даної книги нажаль немає')
    #
    # try:
    #     await library.create_request(reader_8, book_1)
    # except Exception:
    #     print('Даної книги нажаль немає')
